export const textbook = {
    list: [
        ...
        {
            des: "Due to a planned power outage, our services will be reduced today (June 15) starting at 8:30am PDT until the work is complete. We apologize for the inconvenience.",
...
export const classicNovel = {
    list: [
        ...
        {
            des: "The family of Dashwood had long been settled in Sussex. Their estate was large, and their residence was at Norland Park, in the centre of their property, where, for many generations, they had lived in so respectable a manner as to engage the general good opinion of their surrounding acquaintance.",
        ...
        },
        {
            ...
            des: "Transcribed from the 1905 Chapman and Hall edition by David\nPrice, email ccx074@pglaf.org\nBy CHARLES DICKENS\nWith illustrations by Marcus\nStone, Maurice\nGreiffenhagen, and F. Walker\nLONDON: CHAPMAN & HALL, LD.\nNEW YORK: CHARLES SCRIBNER’S SONS\n1905\nBOOK THE\nFIRST.  SOWING\n \nPAGE\nCHAPTER I\nThe One Thing Needful\n3\nCHAPTER II\nMurdering the Innocents\n4\nCHAPTER III\nA Loophole\n8\nCHAPTER IV\nMr. Bounderby\n12\nCHAPTER V\nThe Keynote\n18\nCHAPTER VI\nSleary’s Horsemanship\n23\nCHAPTER VII\nMrs. Sparsit\n33\nCHAPTER VIII",
            url: "https://www.gutenberg.org/files/786/786-h/786-h.htm",
            icon: "",
        },
        {
            title: "Emma, by Jane Austen",
            url: "https://www.gutenberg.org/files/158/158-h/158-h.htm",
            des: "Emma Woodhouse, handsome, clever, and rich, with a comfortable home and happy disposition, seemed to unite some of the best blessings of existence; and had lived nearly twenty-one years in the world with very little to distress or vex her.",
            icon: "",
        },
        {
            title: "Hard Times, By CHARLES DICKENS",
            url: "https://www.gutenberg.org/cache/epub/786/pg786-images.html",
            des: "‘Now, what I want is, Facts.  Teach these boys and girls nothing but Facts.  Facts alone are wanted in life.  Plant nothing else, and root out everything else.  You can only form the minds of reasoning animals upon Facts: nothing else will ever be of any service to them.  This is the principle on which I bring up my own children, and this is the principle on which I bring up these children.  Stick to Facts, sir!’",
            icon: "",
        },
        {
