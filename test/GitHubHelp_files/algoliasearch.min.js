    ...
    return function t(e, r, o) {
        ...
        16: [function(e, t, r) {
            ...
            o.prototype.assignUserIDs = function(e, t) {
                if (!e.userIDs || !e.cluster)
                    throw new l.AlgoliaSearchError("You have to provide both an array of userIDs and cluster",e);
                return this._jsonRequest({
                    method: "POST",
            ...
            o.prototype.getSecuredApiKeyRemainingValidity = n
        }
        , {
            17: 17,
            18: 18,
        ...
        18: [function(e, t, r) {
            ...
            o.prototype.exists = function(e) {
                var t = this.getSettings().then(function() {
                    ...
                    if (e instanceof l.AlgoliaSearchError && 404 === e.statusCode)
                        return !1;
                    throw e
                });
            ...
            o.prototype.findObject = function(e, t, r) {
                t = void 0 === t ? {} : t;
                var o = void 0 === t.paginate || t.paginate
                  , n = void 0 !== t.query ? t.query : ""
                  , i = this
                  , s = 0
                  , a = function() {
                    return t.page = s,
                    i.search(n, t).then(function(t) {
                        ...
                        if (s += 1,
                        !o || s >= t.nbPages)
                            throw new l.ObjectNotFound("Object not found");
                        return a()
                    })
                }
                  , c = a(s);
                return void 0 === r ? c : void c.then(function(e) {
                    r(null, e)
                })["catch"](function(e) {
                    r(e)
                })
...
console.log("algoliasearch.js 运行结束");
